...
ARG IMAGE_REPO="casjaysdevdocker/nginx"
...
ARG PACK_LIST="nginx nginx-mod-http-brotli nginx-mod-http-cache-purge nginx-mod-http-dav-ext nginx-mod-http-echo nginx-mod-http-encrypted-session nginx-mod-http-fancyindex nginx-mod-http-geoip nginx-mod-http-geoip2 nginx-mod-http-headers-more nginx-mod-http-image-filter nginx-mod-http-js nginx-mod-http-lua nginx-mod-http-perl nginx-mod-http-redis2 nginx-mod-http-set-misc nginx-mod-http-shibboleth nginx-mod-http-untar nginx-mod-http-upload nginx-mod-http-upload-progress nginx-mod-http-upstream-fair nginx-mod-http-xslt-filter nginx-mod-http-zip "
...
ENV HOSTNAME="casjaysdevdocker-nginx"
...
LABEL org.opencontainers.image.url="https://docker.io/casjaysdevdocker/nginx"
LABEL org.opencontainers.image.source="https://docker.io/casjaysdevdocker/nginx"
LABEL org.opencontainers.image.vcs-type="Git"
LABEL org.opencontainers.image.revision="${GIT_COMMIT}"
LABEL org.opencontainers.image.source="https://github.com/casjaysdevdocker/nginx"
LABEL org.opencontainers.image.documentation="https://github.com/casjaysdevdocker/nginx"
